...
export const CanonicalLink = () => {
  ...
  useEffect(() => {
    if (isKutuPage || isKupBloknotPage || isEtiketPage || isBloknotlarPage || isAntetliPage) {
  ...
  }, [canonicalUrl, schemas, isInvalidSectorPage, isKutuPage, isAmbalajPage, isKupBloknotPage, isEtiketPage, isBloknotlarPage, isAntetliPage]);

  if (isInvalidSectorPage || isKutuPage || isAmbalajPage || isKupBloknotPage || isEtiketPage || isBloknotlarPage || isAntetliPage) {
    return null;
  }
...
const SEOMetadataManager = () => {
  ...
  useEffect(() => {
    ...
    if (pathname === '/kutu' || pathname === '/ambalaj' || pathname === '/kup-bloknot' || pathname === '/etiket' || pathname === '/bloknotlar' || pathname === '/antetli') {
      const scriptEl = document.getElementById('app-seo-metadata-jsonld');
      if (scriptEl) scriptEl.remove();
      return;
    }
    ...
    if (pathname !== '/' && !pathname.startsWith('/blog') && pathname !== '/ambalaj') {
      const breadcrumb = {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "itemListElement": [
