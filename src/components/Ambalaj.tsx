...
import { useCart, AgencyDiscountCTA, FeatureTooltip } from '../App';
...
export const AmbalajPage = () => {
  ...
  const [activeLegalPolicy, setActiveLegalPolicy] = useState<PolicyType | null>(null);

  const isAmbalajImageValid = (imgSrc?: string) => Boolean(imgSrc && (AMBALAJ_IMAGE_MANIFEST as Record<string, boolean>)[imgSrc]);
  ...
  useEffect(() => {
    document.title = AMBALAJ_SEO_METADATA.title;
    ...
    if (appSeoScript) appSeoScript.remove();

    const schemasToManage = [
      { id: 'ambalaj-breadcrumb-schema', data: AMBALAJ_SCHEMAS.breadcrumbSchema },
      { id: 'ambalaj-service-schema', data: AMBALAJ_SCHEMAS.serviceSchema },
      { id: 'ambalaj-faq-schema', data: AMBALAJ_SCHEMAS.faqSchema },
    ];
    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 mt-4 animate-in fade-in duration-500">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-6 flex-wrap">
          ...
          <ChevronRight size={14} className="text-gray-400" />
          <span className="text-black font-bold" aria-current="page">Ambalaj Baskı</span>
        </nav>
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-neutral-100 shadow-sm mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5">
              {isAmbalajImageValid("/images/ambalaj/ambalaj-baski-cozumleri.webp") ? (
                <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-md bg-slate-100 min-h-[240px] flex items-center justify-center relative">
                  <img 
                ...
                <div
                  ...
                  className="w-full h-full min-h-[240px] aspect-[8/5] border border-dashed border-slate-300 rounded-2xl flex flex-col items-center justify-center p-6 text-center bg-slate-50/90"
                >
                  <div className="w-10 h-10 rounded-full bg-slate-200/80 text-slate-500 flex items-center justify-center mb-2 shrink-0">
                    <ImageIcon size={20} />
                  </div>
                  <span className="text-xs font-extrabold tracking-wider uppercase text-slate-400">
                    BASKILI AMBALAJ KÂĞIDI
                  </span>
                  <span className="text-sm font-bold text-slate-800 mt-1">
                    Ambalaj Baskı Çözümleri
                  </span>
        ...
        <section id="secenekler" className="space-y-6 mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {AMBALAJ_PRODUCTS.map((prod, index) => {
              ...
              const isProdImageAvailable = isAmbalajImageValid(prod.image);
              return (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mt-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-xs md:text-sm">
                <caption className="sr-only">Standart Ambalaj Kâğıdı Paket ve Fiyat Listesi</caption>
                <thead>
                  <tr className="bg-black text-white">
                    <th scope="col" className="p-3.5 w-24 font-bold text-center border-r border-white/10">KOD</th>
                    <th scope="col" className="p-3.5 text-left font-bold border-r border-white/10">ÜRÜN VE KÂĞIT ÖZELLİĞİ</th>
                    <th scope="col" className="p-3.5 w-32 font-bold text-center border-r border-white/10">STANDART MİKTAR</th>
                    <th scope="col" className="p-3.5 w-36 font-bold text-center border-r border-white/10">FİYAT</th>
                    <th scope="col" className="p-3.5 w-40 font-bold text-center">BİLGİ &amp; SİPARİŞ</th>
                  </tr>
                </thead>
                <tbody>
                  {AMBALAJ_PRICE_TABLE.map((item, idx) => (
                    <tr key={idx} className="border-b border-gray-100 hover:bg-primary/5 transition-all">
                      <th scope="row" className="p-3.5 text-center font-bold text-black border-r border-gray-100">
                        {item.code}
                      </th>
          ...
          <div className="mt-4">
            <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 text-center">
              <p className="text-slate-500 font-semibold text-xs leading-relaxed">
                * Ofset baskıda renk, kesim ve adet toleransları oluşabilir. Ayrıntılı bilgi için{' '}
                <button 
                  type="button" 
                  onClick={() => setActiveLegalPolicy('delivery')}
                  className="underline hover:text-primary transition-colors cursor-pointer font-bold text-slate-700 hover:underline inline-flex items-center"
                >
                  Teslimat Koşulları
                </button>{' '}
        ...
        <section id="malzeme-karsilastirmasi" className="bg-white rounded-3xl p-6 sm:p-10 border border-neutral-200 shadow-sm space-y-6 mb-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5">
              {isAmbalajImageValid("/images/ambalaj/ambalaj-kagit-ve-malzemeleri.webp") ? (
                ...
                <div
                  aria-hidden="true"
                  className="w-full aspect-[3/2] border-2 border-dashed border-slate-300 rounded-2xl flex flex-col items-center justify-center p-6 text-center bg-slate-50/90"
                >
                  <div className="w-10 h-10 rounded-full bg-slate-200/80 text-slate-500 flex items-center justify-center mb-2 shrink-0">
                    <ImageIcon size={20} />
                  </div>
          ...
          <div className="pt-6 border-t border-gray-100">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs md:text-sm">
                <caption className="sr-only">Ambalaj Kâğıdı Türleri ve Malzeme Özellikleri Karşılaştırması</caption>
                <thead>
                  <tr className="bg-slate-100 text-black border-b border-slate-300">
                    <th scope="col" className="p-3 font-bold">Kâğıt Türü</th>
                    <th scope="col" className="p-3 font-bold">Gramaj</th>
                    <th scope="col" className="p-3 font-bold">Standart Ebat</th>
                    <th scope="col" className="p-3 font-bold">Öne Çıkan Kullanım Alanı</th>
                    <th scope="col" className="p-3 font-bold">Baskı Türü</th>
                    <th scope="col" className="p-3 font-bold">Kullanım &amp; Gıda Özelliği</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 text-gray-700">
                  {AMBALAJ_TECH_SPECS.map((spec, sIdx) => (
                    <tr key={sIdx} className="hover:bg-slate-50">
                      <th scope="row" className="p-3 font-bold text-black">{spec.kagitTuru}</th>
        ...
        <section id="dosya-ve-prova" className="bg-white rounded-3xl p-6 sm:p-10 border border-neutral-100 shadow-sm space-y-6 mb-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5">
              {isAmbalajImageValid("/images/ambalaj/ambalaj-baski-pdf-prova.webp") ? (
                <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-md bg-slate-100">
                  <img 
        ...
        <section id="ilgili-baski-urunleri" className="space-y-6 mb-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 hidden lg:block">
              {isAmbalajImageValid("/images/ambalaj/ambalaj-baski-urunleri.webp") ? (
                ...
                <div
                  aria-hidden="true"
                  className="w-full aspect-[3/2] border border-dashed border-slate-300 rounded-xl flex flex-col items-center justify-center p-4 text-center bg-slate-50/90"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-200/80 text-slate-500 flex items-center justify-center mb-1 shrink-0">
                    <ImageIcon size={18} />
                  </div>
                  <span className="text-[10px] font-extrabold tracking-wider uppercase text-slate-400">
                    TAMAMLAYICI ÜRÜNLER
      ...
      {activeLegalPolicy && (
        <LegalPolicyModal 
          type={activeLegalPolicy} 
          onClose={() => setActiveLegalPolicy(null)} 
        />
      )}
    </div>
  );
