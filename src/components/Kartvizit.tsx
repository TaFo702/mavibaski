  ...
  return (
    <div data-page-root="kartvizit" className="bg-white min-h-screen pb-16">
      <Helmet>
        ...
        <meta property="og:title" content="Kartvizit Baskı Fiyatları | 1.000 Adet ve Kalın Kartvizit" />
        <meta property="og:description" content="1.000 adet kartvizit baskı fiyatlarını inceleyin. 250–800 gr, mat veya parlak selefon, kabartma lak, sıvama, özel kesim ve PVC seçenekleri." />
        <meta property="og:url" content="https://mavibasim.com/kartvizit" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="https://mavibasim.com/images/kartvizit/kartvizit-baski-fiyatlari.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/kartvizit/kartvizit-baski-fiyatlari.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım 1000 adet kabartma laklı, sıvamalı ve kalın kartvizit baskı çeşitleri" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Kartvizit Baskı Fiyatları | 1.000 Adet ve Kalın Kartvizit" />
        <meta name="twitter:description" content="1.000 adet kartvizit baskı fiyatlarını inceleyin. 250–800 gr, mat veya parlak selefon, kabartma lak, sıvama, özel kesim ve PVC seçenekleri." />
        <meta name="twitter:image" content="https://mavibasim.com/images/kartvizit/kartvizit-baski-fiyatlari.webp" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-14">
          ...
          <section className="bg-amber-50/80 p-6 sm:p-8 rounded-3xl border border-amber-200/80 flex flex-col justify-between">
            ...
            <div className="mt-4 p-3 bg-white/80 rounded-xl border border-amber-200 text-xs font-bold text-amber-900">
              💡 Baskıya hazır dosyalarınız için teknik kontrol ve dijital PDF prova sunulmaktadır. Grafik desteği var.
            </div>
          </section>
        </div>
