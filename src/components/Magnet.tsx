  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20 text-slate-900" data-page-root="magnet">
      <Helmet>
        ...
        <meta property="og:image" content="https://mavibasim.com/images/magnet/magnet-baski-fiyatlari.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/magnet/magnet-baski-fiyatlari.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım buzdolabı magnet baskı fiyatları ve özel kesim magnet modelleri" />
        ...
        <meta name="twitter:image" content="https://mavibasim.com/images/magnet/magnet-baski-fiyatlari.webp" />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-xs md:text-sm text-slate-650 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <p>
                  Etkili bir <strong>magnet tasarımı</strong> için telefon numarası ve iletişim bilgilerinin okunaklı olması önerilir. Düğün, nişan veya hatıra amaçlı <strong>hediyelik magnet fiyatları</strong>, <strong>resimli magnet</strong> veya kişisel <strong>magnet fotoğraf</strong> ürünlerinin aksine, sunduğumuz hizmet doğrudan kurumsal ve ticari buzdolabı tanıtım magnetleridir. Grafik desteği var. Dosya hazırlığı veya özel ebat talepleriniz için ekibimizle görüşebilirsiniz.
                </p>
              </div>
            </div>
          </div>
