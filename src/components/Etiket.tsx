...
export const EtiketPage = () => {
  ...
  useEffect(() => {
    document.title = ETIKET_SEO_METADATA.title;
    ...
    <div className="bg-white min-h-screen">
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <ol className="flex items-center space-x-2 text-xs sm:text-sm text-slate-500 flex-wrap">
            ...
            <li>
              <Link to="/matbaa" className="hover:text-primary transition-colors">
                Matbaa Ürünleri
              </Link>
            </li>
            <li className="text-slate-400">/</li>
            <li className="text-slate-900 font-bold" aria-current="page">
              Etiket Baskı Fiyatları
            </li>
          </ol>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 max-w-7xl pt-4 pb-12">
        <CategoryHero 
          ...
          description="Ürün ambalajlarınız, kutularınız, cam kavanoz veya şişeleriniz için kuşe etiket baskı, PP opak plastik etiket ve şeffaf yapışkanlı etiket çözümleri. Matbaa etiket baskı ve online etiket baskı ihtiyaçlarınızda baskıya hazır dosyalarınızı ileterek siparişlerinizi İstanbul Topkapı 2. Matbaacılar Sitesi hizmet ve koordinasyon noktamız üzerinden kolayca planlayabilirsiniz."
          badge="Yapışkanlı Sticker ve Ürün Etiketi Baskı"
          trustSignals={[
            { text: "İstanbul Topkapı 2. Matbaacılar Sitesi hizmet ve koordinasyon noktası" },
            { text: "Ürün ve malzeme bilgilerinin netleştirilmesi" },
            { text: "Kuşe, PP opak ve şeffaf etiket seçenekleri" },
            { text: "Sipariş bilgileri netleştirildikten sonra planlama" }
          ]}
        />
        ...
        <div className="mb-8 -mt-2 bg-slate-50 border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs md:text-sm text-slate-700">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-semibold">
              Baskı öncesi ürün, malzeme, ölçü ve adet bilgileri netleştirilir.
            </span>
          </div>
        ...
        <section id="fiyat-tablosu" className="scroll-mt-24 mb-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div>
              <div className="flex items-center gap-2.5">
                ...
                <h2 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tight">
                  Yapışkanlı Etiket Baskı Fiyatları
                </h2>
              </div>

              <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
                Baskılı etiket fiyatları; kuşe, şeffaf ve PP opak yapışkanlı etiket seçeneklerine göre değerlendirilir.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 bg-emerald-50 text-emerald-700 border border-emerald-200 px-3.5 py-1.5 rounded-full text-xs font-bold shrink-0 self-start sm:self-auto">
              ...
              <span>Kuşe &amp; PP Opak Etiketler</span>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-200 shadow-sm bg-white mb-8">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <caption className="sr-only">
                  Yapışkanlı Etiket Baskı Fiyat Listesi
                </caption>

                <thead>
                  <tr className="bg-black text-white">
                    <th scope="col" className="p-4 w-10"></th>
                    <th scope="col" className="p-4 w-24 font-black uppercase tracking-tight text-[14px] md:text-[16px] border-r border-white/10">
                      KOD
                    </th>
                    <th scope="col" className="p-4 text-center font-black uppercase tracking-tight text-[14px] md:text-[16px] border-r border-white/10">
                      EBAT
                    </th>
                    <th scope="col" className="p-4 text-center font-black uppercase tracking-tight text-[14px] md:text-[16px] border-r border-white/10">
                      ÖZELLİKLER
                    ...
                    <th scope="col" className="p-4 w-32 font-black uppercase tracking-tight text-[14px] md:text-[16px] border-r border-white/10">
                      FİYAT
                    </th>
                    <th scope="col" className="p-4 w-44 font-black uppercase tracking-tight text-[14px] md:text-[16px] text-center">
                      SİPARİŞ
                    </th>
                  </tr>
                </thead>
                ...
                <tbody>
                  {ETIKET_DATA.map((item, idx) => (
                    <tr
                      key={idx}
                      className="border-b border-gray-100 hover:bg-primary/10 hover:shadow-[inset_4px_0_0_0_#29abe2] transition-all cursor-default group"
                    >
                      {idx === 0 && (
                        <th
                          scope="rowgroup"
                      ...
                      <th
                        scope="row"
                        className="p-3 text-center font-bold text-primary border-r border-gray-100 group-hover:text-secondary transition-colors font-sans"
                      >
                        {item.code}
                      </th>

                      <td className="p-3 text-center font-medium text-black border-r border-gray-100">
                        {item.ebat}
                      </td>
                      ...
                      <td className="p-3 text-center text-black font-medium border-r border-gray-100 whitespace-nowrap">
                        1.000 Adet
                      </td>
            ...
            <div className="bg-amber-50/80 px-4 py-3.5 border-t border-amber-200/80 flex flex-col gap-2 text-xs font-medium font-sans">
              <div className="flex items-start gap-2 text-amber-900 font-bold text-xs md:text-sm leading-snug">
                ...
                <span>
                  * Tablomuz standart kuşe çıkartma etiket fiyatlarını içermektedir.
                  PP Opak, şeffaf, sökülebilir ve rulo etiket seçenekleri için bilgi alabilirsiniz.
                </span>
              </div>
        ...
        <div className="mt-12 mb-12 scroll-mt-24">
          ...
          <p className="text-sm md:text-base text-gray-600 font-medium leading-relaxed mb-6 px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ETIKET_GALLERY.map((img, idx) => (
              ...
              >
                ...
                <div className="mt-2">
                  <h3 className="text-sm font-black text-black uppercase mb-1.5">
                    {img.title}
                  </h3>
        ...
        <div className="mt-16 space-y-16">
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-black mb-6 uppercase tracking-tight">
              Yapışkanlı Etiket ve Sticker Baskı Çözümleri
            </h2>
            ...
            <div className="prose prose-slate max-w-none text-black leading-relaxed">
              <p className="text-base md:text-lg mb-6">
                ...
                olarak, İstanbul Topkapı 2. Matbaacılar Sitesi hizmet ve koordinasyon noktamızdan matbaa etiket baskı, ürün etiketi baskı ve yapışkanlı sticker baskı seçenekleri sunuyoruz. Etiket baskı matbaa sürecinde ürün ve malzeme bilgileri netleştirilir. Kuşe, PP opak etiket baskı ve şeffaf etiket seçenekleri için sipariş bilgileri değerlendirilir.
              </p>

              <p className="text-base md:text-lg mb-6">
                Online etiket baskı taleplerinizde kuşe, PP opak etiket baskı ve şeffaf yapışkanlı etiket seçenekleri incelenir. Malzeme ve yüzey seçimi, mevcut ürün bilgileri ile sipariş özellikleri doğrultusunda değerlendirilir. Fiyat tablosunda standart kuşe etiket seçenekleri yer alır; diğer malzeme seçenekleri için bilgi alınabilir.
              </p>

              <p className="text-base md:text-lg">
                Ürün sticker baskı ve etiket basım taleplerinde ürün, malzeme, ölçü ve adet bilgileri netleştirilir. Toptan etiket baskı siparişlerinde baskı ve kesim seçenekleri mevcut ürün bilgileri doğrultusunda değerlendirilir.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-10">
            ...
            <p className="text-gray-600 font-medium mb-8">
              Etiket malzemesi seçimi; uygulama yüzeyi, istenen görünüm ve sipariş özellikleri birlikte değerlendirilerek yapılır:
            </p>
              ...
              <table className="w-full text-left border-collapse text-xs md:text-sm">
                ...
                <thead>
                  <tr className="bg-slate-900 text-white">
                    <th scope="col" className="p-4 rounded-tl-xl font-black uppercase">
                      Malzeme Türü
                    </th>
                    ...
                    <th scope="col" className="p-4 rounded-tr-xl font-black uppercase">
                      Genel Açıklama
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {ETIKET_COMPARISON_DATA.map((item, idx) => (
                    <tr key={idx}>
                      <th scope="row" className="p-4 font-black text-black text-left">
                        {item.material}
                      </th>
            ...
            <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3 text-xs md:text-sm text-amber-900 font-medium">
              ...
              <p>
                <strong>Malzeme Seçimi:</strong> Kuşe, PP opak, şeffaf ve sökülebilir etiket seçenekleri; yüzey, görünüm ve sipariş bilgileri doğrultusunda değerlendirilir. Belirli bir kullanım koşulu için kesin sonuç bu sayfada belirtilmemektedir.
              </p>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:border-primary transition-all">
                ...
                <h3 className="text-lg font-black text-black mb-2">
                  Yapışkanlı Etiket Seçenekleri
                </h3>

                <p className="text-gray-600 text-sm font-medium leading-relaxed">
                  Yapışkan türü, uygulama yüzeyi ve sipariş özellikleri doğrultusunda değerlendirilir.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:border-primary transition-all">
                ...
                <h3 className="text-lg font-black text-black mb-2">
                  Özel Yapışkan Seçenekleri
                </h3>

                <p className="text-gray-600 text-sm font-medium leading-relaxed">
                  Yapışkan türü, uygulama yüzeyi ve kullanım koşulları birlikte değerlendirilerek netleştirilir.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:border-primary transition-all">
                ...
                <h3 className="text-lg font-black text-black mb-2">
                  Parlak &amp; Mat Selefon Lamine
                </h3>

                <p className="text-gray-600 text-sm font-medium leading-relaxed">
                  Parlak ve mat selefon seçenekleri, etiket yüzeyinin görünüm tercihine göre değerlendirilir.
                </p>
              </div>
            </div>
          </section>
            ...
            <section className="bg-gray-50 p-8 rounded-[32px] border border-gray-200">
              ...
              <ul className="space-y-4">
                {[
                  {
                    label: "Baskı Yüzeyi",
                    value: "Tek taraflı çok renkli baskı seçeneği (Arka yüzey taşıyıcı kağıt)"
                  },
                  {
                    label: "Malzeme Türü",
                    value: "90 gr Kuşe Kağıt veya PP Opak Plastik / Şeffaf Film alternatifleri"
                  },
                  {
                    label: "Ebat & Kesim",
                    value: "Etiket ölçüsü ve kesim bilgisi sipariş öncesinde netleştirilir."
                  },
                  {
                    label: "Yüzey Görünümü",
                    value: "Parlak veya Mat Selefon seçenekleri"
                  },
                  {
                    label: "Kesim Seçeneği",
                    value: "Kesim seçeneği ürün ve tasarım bilgileri doğrultusunda netleştirilir."
                  }
                ].map((item, idx) => (
            ...
            <section className="bg-red-50 p-8 rounded-[32px] border border-red-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-black text-red-700 uppercase tracking-tight">
                  Etikette Sık Yapılan 5 Teknik Hata
                </h2>
              </div>
              ...
              <ul className="space-y-4">
                {[
                  {
                    title: "Malzeme Bilgisinin Netleştirilmemesi",
                    desc: "Etiket ölçüsü, malzeme ve uygulama yüzeyinin sipariş öncesinde belirtilmemesi."
                  },
                  {
                    title: "Ölçü Bilgisinin Eksik Olması",
                    desc: "Tasarım ölçüsünün netleştirilmemesi baskı planlamasını zorlaştırabilir."
                  },
                  {
                    title: "Baskı İçeriğinin Gözden Geçirilmemesi",
                    desc: "Metin ve görsel bilgilerinin sipariş öncesinde tekrar değerlendirilmemesi."
                  },
                  {
                    title: "Küçük Tipografi & Font Boyutu",
                    desc: "İçindekiler veya bilgilendirme metinlerinde çok küçük puntoların okunabilirliği zorlaştırması."
                  },
                  {
                    title: "Yüzey Bilgisinin Belirtilmemesi",
                    desc: "Uygulama yüzeyinin belirtilmemesi malzeme seçimini zorlaştırabilir."
                  }
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    ...
                    <p className="text-sm md:text-base font-bold text-red-950">
                      {item.title}{' '}
                      <span className="text-red-700 font-medium block text-xs mt-0.5">
                        → {item.desc}
                      </span>
                    </p>
                  </li>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700">
                ...
                <p className="text-gray-300 text-xs md:text-sm font-medium leading-relaxed">
                  Tasarım ölçüsü ve kesim bilgisi, çalışma hazırlanırken netleştirilmelidir.
                </p>
              </div>
              ...
              <div className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700">
                ...
                <div className="text-gray-300 text-xs md:text-sm font-medium leading-relaxed">
                  Tasarımın baskı ve kesim alanıyla uyumu sipariş öncesinde değerlendirilmelidir.
                </div>
              </div>
              ...
              <div className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700">
                ...
                <p className="text-gray-300 text-xs md:text-sm font-medium leading-relaxed">
                  Logo, metin, barkod ve benzeri grafik unsurların görünümü tasarım ve zemin birlikte değerlendirilerek hazırlanmalıdır.
                </p>
              </div>
              ...
              <div className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700">
                ...
                <p className="text-gray-300 text-xs md:text-sm font-medium leading-relaxed">
                  Renk ve yüzey görünümü, seçilen malzeme ve baskı seçeneğine göre değerlendirilmelidir.
                </p>
              </div>
            </div>
          </section>
              ...
              {[
                {
                  ...
                  desc: "Ürün, ölçü, malzeme ve adet bilgileri netleştirilir."
                },
                {
                  step: "2",
                  title: "Baskı Bilgileri",
                  desc: "Baskı seçenekleri ve sipariş bilgileri netleştirilir."
                },
                {
                  step: "3",
                  title: "Baskı Aşaması",
                  desc: "Seçilen ürün bilgileri doğrultusunda baskı seçeneği değerlendirilir."
                },
                {
                  step: "4",
                  title: "Selefon Seçeneği",
                  desc: "Mat veya parlak selefon seçeneği değerlendirilir."
                },
                {
                  step: "5",
                  title: "Kesim İşlemi",
                  desc: "Kesim seçeneği ürün ve tasarım bilgileri doğrultusunda netleştirilir."
                },
                {
                  step: "6",
                  title: "Sipariş Sonu",
                  desc: "Siparişin sonraki aşamaları, netleştirilen ürün ve sipariş bilgileri doğrultusunda planlanır."
                }
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm relative pt-8"
                >
                  ...
                  <h3 className="font-black text-black text-sm mb-1.5">
                    {item.title}
                  </h3>
          ...
          <section
            className="bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-10 scroll-mt-24"
            id="faq"
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              {[
                {
                  ...
                  desc: "Özel kesimli ambalaj ve ürün kutuları.",
                  path: "/kutu"
                },
                {
                  title: "Karton Çanta",
                  desc: "Lüks ipli kurumsal mağaza çantaları.",
                  path: "/karton-canta"
                },
                {
                  title: "Broşür Baskı",
                  desc: "Ürün ve hizmet tanıtım broşürleri.",
                  path: "/brosur"
                },
                {
                  title: "Kartvizit Baskı",
                  desc: "Kurumsal ilk izlenim kartvizitleri.",
                  path: "/kartvizit"
                }
              ].map((product, idx) => (
                <Link
                  key={idx}
                  to={product.path}
                  className="group bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl hover:border-primary transition-all"
                >
          ...
          <RelatedBlogPosts
            category="etiket"
            excludeImages={["/images/etiket/yapiskanli-etiket-baski.webp"]}
          />
        </div>
      </div>
    </div>
