  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://mavibasim.com/etiket" />
        <meta property="og:title" content="Sticker ve Etiket Baskı Fiyatları | PP Opak &amp; Kuşe - Mavi Basım" />
        <meta property="og:description" content="Ürün ambalajlarınız için suya dayanıklı PP opak plastik etiket, kuşe yapışkanlı sticker ve şeffaf etiket baskısı. İstanbul Topkapı matbaasından kapınıza hızlı kargo." />
        <meta property="og:url" content="https://mavibasim.com/etiket" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="https://mavibasim.com/images/etiket/etiket-baski-fiyatlari.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/etiket/etiket-baski-fiyatlari.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım rulo ve tabaka etiket baskı fiyatları, yapışkanlı kuşe ve şeffaf sticker çeşitleri" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sticker ve Etiket Baskı Fiyatları | PP Opak &amp; Kuşe - Mavi Basım" />
        <meta name="twitter:description" content="Ürün ambalajlarınız için suya dayanıklı PP opak plastik etiket, kuşe yapışkanlı sticker ve şeffaf etiket baskısı. İstanbul Topkapı matbaasından kapınıza hızlı kargo." />
        <meta name="twitter:image" content="https://mavibasim.com/images/etiket/etiket-baski-fiyatlari.webp" />
      </Helmet>
