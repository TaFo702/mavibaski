          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
                Kuşe, şeffaf ve PP opak yapışkanlı etiket ve sticker fiyatları
              </p>
            </div>
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none text-black leading-relaxed">
              <p className="text-base md:text-lg mb-6">
                ...
                olarak, İstanbul Topkapı 2. Matbaacılar Sitesi hizmet ve koordinasyon noktamızdan matbaa etiket baskı, ürün etiketi baskı ve yapışkanlı sticker baskı seçenekleri sunuyoruz. Kuşe, PP opak ve şeffaf etiket seçenekleri için ürün ve malzeme bilgileri netleştirilir.
              </p>

              <p className="text-base md:text-lg mb-6">
                Online etiket baskı taleplerinizde kuşe, PP opak ve şeffaf yapışkanlı etiket seçenekleri incelenir. Malzeme ve yüzey seçimi, mevcut ürün bilgileri ile sipariş özellikleri doğrultusunda değerlendirilir. Fiyat tablosunda standart kuşe etiket seçenekleri yer alır; diğer malzeme seçenekleri için bilgi alınabilir.
              </p>
