...
import { ChevronDown, ShoppingCart, Phone, Layers, ExternalLink } from 'lucide-react';
import { 
  useCart, 
...
export const AMERIKAN_SERVIS_FAQS = [
  {
    ...
    a: "Amerikan servis baskı fiyatları; seçilen ebat, kâğıt türü ve gramajı (90 gr 1. Hamur, 100 gr kuşe veya 120 gr 1. Hamur), baskı adedi ve renk seçeneklerine göre belirlenir. Standart paketlerimiz 2.000 adet üzerinden sunulmakta olup farklı adet seçenekleri için fiyat bilgisi sipariş detaylarına göre paylaşılır."
  },
  {
...
export const AMERIKAN_SERVIS_GALLERY = [
  {
    ...
    alt: "Amerikan Servis Baskı Modelleri ve Kağıt Servis Altlığı Örnekleri",
    title: "Amerikan Servis Baskı Modelleri",
    desc: "Restoran ve kafeler için renkli baskılı kağıt servis altlığı modelleri."
  },
  {
    filename: "restoran-amerikan-servis.webp",
    src: "/images/amerikan-servis/restoran-amerikan-servis.webp",
    alt: "Amerikan Servis Tasarımı ve Masa Düzeni Örnekleri",
    title: "Amerikan Servis Tasarımı ve Modelleri",
    desc: "Restoran ve kafeler için kağıt servis altlığı ve masa düzenini anlatan temsili tasarım görseli."
  },
  {
    filename: "kagit-amerikan-servis.webp",
    src: "/images/amerikan-servis/kagit-amerikan-servis.webp",
    alt: "Kağıt Amerikan Servis Ölçüleri ve Servis Baskı Örneği",
    title: "Kağıt Amerikan Servis Ölçüleri",
    desc: "31x44 cm ebatlarında kağıt Amerikan servis altlığı baskı örneği."
  },
  {
    ...
    desc: "Marka logosu ve dijital menü QR kodlu servis altlığı örneği."
  },
  {
    filename: "ozel-tasarim-amerikan-servis.webp",
    src: "/images/amerikan-servis/ozel-tasarim-amerikan-servis.webp",
    alt: "Özel Tasarım Kağıt Amerikan Servis Baskı Örneği",
    title: "Özel Tasarım Amerikan Servis",
    desc: "Özel tasarım yaklaşımını anlatan temsili Amerikan servis görseli."
  },
  {
    filename: "placemat-baski.webp",
    src: "/images/amerikan-servis/placemat-baski.webp",
    alt: "Placemat Kağıt Servis Altlığı Baskı Örneği",
    title: "Placemat Servis Altlığı Baskısı",
    desc: "Restoran ve kafeler için masa sunumu placemat kağıt servis altlığı."
  }
];

type AmericanServisItem =
  (typeof AMERIKAN_SERVIS_DATA)[number]['items'][number];

export const AmerikanServisPage = () => {
  const { openProductDetail } = useCart();

  const openWhatsApp = (item: AmericanServisItem) => {
  ...
  useEffect(() => {
    document.title = "Amerikan Servis Baskı Fiyatları | Kağıt Servis Altlığı";
  }, []);
...
<div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-6">
  <nav
    className="text-xs font-bold text-gray-500 uppercase tracking-tight flex items-center gap-1.5"
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-black">
        ...
        <div className="scroll-mt-24 group mb-10" id="fiyat-tablosu">
          ...
          <p className="text-gray-650 text-xs sm:text-sm font-semibold mb-6 px-2 leading-relaxed">
            Bu sayfadaki standart Amerikan servis baskı paketleri 2.000 adetten başlamaktadır. İlave adetlerin fiyatları tabloda ayrıca gösterilmektedir. Fiyat tablosunda 2.000 adetlik kağıt Amerikan servis baskı seçenekleri; ürün, ebat ve gramaj bilgileriyle birlikte incelenebilir.
          </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-visible relative z-10">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[11px] md:text-[13px]">
                <caption className="sr-only">Amerikan Servis Fiyat Listesi</caption>
                <thead>
...
>
  <span className="tracking-[0.1em] uppercase text-[10px]">SERVİS</span>
                      ...
                      <th scope="row" className="p-3 text-center font-bold text-primary border-r border-gray-100 group-hover:text-secondary transition-colors font-sans font-normal">
                        {item.code}
                      </th>
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <ul className="text-xs text-gray-700 space-y-3 list-none font-semibold">
                    ...
                    <li><strong className="text-black block mb-0.5">Gramaj Özelliği:</strong> 90 gr ağırlığıyla günlük restoran ve kafe servis düzeninde hafif ve pratik bir yapı sunar.</li>
                    ...
                    <li><strong className="text-black block mb-0.5">Öne Çıkan Yönü:</strong> Sade masa sunumu oluşturan bir <strong className="text-black">Amerikan servis kağıdı</strong> alternatifidir.</li>
                  </ul>
                </div>
              </div>
        ...
        <div className="mb-12 scroll-mt-24" id="gorsel-galeri">
          ...
          <p className="text-xs sm:text-sm text-gray-500 font-medium mb-6 px-2">
            Galerideki görseller yapay zekâ ile oluşturulmuş temsili tasarım görselleridir; gerçek müşteri işi veya üretim fotoğrafı değildir.
          </p>
...
/>
        ...
        <div className="space-y-8 mb-12 text-black">
          ...
          <section className="bg-white p-6 md:p-8 rounded-3xl border border-gray-150 shadow-sm">
            ...
            <div className="space-y-3 text-xs sm:text-sm font-semibold leading-relaxed text-gray-650 text-justify">
              <p>
                Yiyecek-içecek sektöründe masa sunumu, müşterilerin işletmenizle ilk temas noktasıdır. <strong>Kağıt servis altlığı</strong> kullanımı, masalarda temiz bir görsel zemin oluştururken tabak ve bardakların masa yüzeyiyle temasını düzenler. Tek kullanımlık yapısıyla her servis döngüsünde düzenli ve temiz bir masa sunumu oluşturulmasını destekler.
              </p>
              <p>
                <strong>Lokanta servis kağıdı</strong> olarak da bilinen bu ürünler, işletmeler için pratik bir servis hazırlığı sağlar. Masanın hızlıca toplanıp bir sonraki servise hazır hale getirilmesine katkıda bulunur. Kullan-at Amerikan servis seçenekleri, tek kullanımlık Amerikan servis ürünleriyle birlikte değerlendirilebilir.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white p-6 md:p-8 rounded-3xl border border-gray-150 shadow-sm">
            ...
            <p className="text-xs sm:text-sm font-semibold leading-relaxed text-gray-650 mb-4">
              Baskılı servis kağıdı ve servis kağıdı tasarımı için mevcut tasarım, logo ve QR kod bilgileri değerlendirilebilir.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs sm:text-sm font-semibold leading-relaxed text-gray-650">
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <h3 className="font-black text-black uppercase text-xs mb-1">
  Ebat ve Taşma Payı
</h3>
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  Tasarım ebadı, kesim alanı ve yazı güvenli alanı seçilen ürün ölçülerine göre hazırlanmalıdır.
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <h3 className="font-black text-black uppercase text-xs mb-1">Renk ve Çözünürlük</h3>
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  Dosyanın renk ayarları ve görsel çözünürlüğü, seçilen baskı özelliklerine uygun hazırlanmalıdır. Ekran ve baskı arasında ton farklılıkları oluşabilir.
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <h3 className="font-black text-black uppercase text-xs mb-1">Vektörel Fontlar</h3>
                <p className="text-[11px] text-gray-600 leading-relaxed">
              ...
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <h3 className="font-black text-black uppercase text-xs mb-1">Teknik Kontrol & Prova</h3>
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  Dosya hazırlığı ve prova sürecinin kapsamı, sipariş detaylarına göre önceden netleştirilir.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-slate-50 p-6 md:p-8 rounded-3xl border border-slate-200">
            ...
            <div className="space-y-2 text-xs sm:text-sm font-semibold text-gray-650 leading-relaxed">
              ...
              <p>
                Sipariş ve teslimatla ilgili ayrıntılar, ürün özellikleri ve sipariş bilgileri netleştirildikten sonra paylaşılır.
              </p>
            </div>
          </section>
  ...
  excludeImages={AMERIKAN_SERVIS_GALLERY.map((image) => image.src)}
/>
        </div>
