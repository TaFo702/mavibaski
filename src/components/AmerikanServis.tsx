  ...
  return (
    <div data-page-root="amerikan-servis" className="bg-white min-h-screen pb-16">
      <Helmet>
        ...
        <meta property="og:title" content="Amerikan Servis Baskı Fiyatları | Kağıt Servis Altlığı" />
        <meta property="og:description" content="2.000 adet Amerikan servis baskı fiyatlarını inceleyin. 90 gr ve 120 gr 1. hamur ile 100 gr kuşe kağıt servis altlığı seçenekleri." />
        <meta property="og:url" content="https://mavibasim.com/amerikan-servis" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="https://mavibasim.com/images/amerikan-servis/amerikan-servis-baski.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/amerikan-servis/amerikan-servis-baski.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım restoran ve kafe için kağıt Amerikan servis baskı çeşitleri" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Amerikan Servis Baskı Fiyatları | Kağıt Servis Altlığı" />
        <meta name="twitter:description" content="2.000 adet Amerikan servis baskı fiyatlarını inceleyin. 90 gr ve 120 gr 1. hamur ile 100 gr kuşe kağıt servis altlığı seçenekleri." />
        <meta name="twitter:image" content="https://mavibasim.com/images/amerikan-servis/amerikan-servis-baski.webp" />
          ...
          <section className="bg-white p-6 md:p-8 rounded-3xl border border-gray-150 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs sm:text-sm font-semibold leading-relaxed text-gray-650">
              ...
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                ...
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  Baskıya hazır dosyanız için teknik kontrol ve PDF provası sunulmaktadır. Grafik desteği var.
                </p>
              </div>
            </div>
          </section>
