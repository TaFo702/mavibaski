...
export const KupBloknotPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const schemasToManage = [
      { id: 'kup-bloknot-breadcrumb-schema', data: KUP_BLOKNOT_SCHEMAS.breadcrumbSchema },
      { id: 'kup-bloknot-product-schema', data: KUP_BLOKNOT_SCHEMAS.productSchema },
      { id: 'kup-bloknot-faq-schema', data: KUP_BLOKNOT_SCHEMAS.faqSchema },
    ];
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 lg:p-10 border border-slate-200 shadow-sm scroll-mt-24" id="fiyat-listesi">
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-600">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-full font-bold transition-all shrink-0 text-xs sm:text-sm"
            >
              <WhatsAppIcon size={18} />
