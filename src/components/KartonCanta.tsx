...
import { KARTON_CANTA_DATA } from '../data/extraProductData';
export { KARTON_CANTA_DATA };
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://mavibasim.com/karton-canta" />
        <meta property="og:title" content="Karton Çanta Baskı Fiyatları | İpli Karton Poşet İmalatı - Mavi Basım" />
        <meta property="og:description" content="Karton çanta baskı, ipli karton poşet, logo baskılı mağaza çantası ve lüks karton ambalaj çözümleri. İstanbul Topkapı üretim, Türkiye geneli kargo, uygun fiyat ve hızlı teslimat." />
        <meta property="og:url" content="https://mavibasim.com/karton-canta" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="https://mavibasim.com/images/karton-canta/karton-canta-imalati.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/karton-canta/karton-canta-imalati.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım lüks ipli karton çanta baskı fiyatları ve mağaza poşeti imalatı" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Karton Çanta Baskı Fiyatları | İpli Karton Poşet İmalatı - Mavi Basım" />
        <meta name="twitter:description" content="Karton çanta baskı, ipli karton poşet, logo baskılı mağaza çantası ve lüks karton ambalaj çözümleri. İstanbul Topkapı üretim, Türkiye geneli kargo, uygun fiyat ve hızlı teslimat." />
        <meta name="twitter:image" content="https://mavibasim.com/images/karton-canta/karton-canta-imalati.webp" />
          ...
          <nav className="flex text-xs text-gray-500 font-medium" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-2 flex-wrap">
              ...
              <li>
                <div className="flex items-center">
                  <span className="mx-2 text-gray-400" aria-hidden="true">/</span>
                  <span className="text-gray-900 font-semibold" aria-current="page">Karton Çanta Baskı</span>
                </div>
              </li>
            </ol>
          </nav>
