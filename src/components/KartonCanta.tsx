...
export const KartonCantaPage = () => {
  ...
  useEffect(() => {
    document.title = "Karton Çanta Baskı Fiyatları | İpli Karton Poşet - Mavi Basım";
  }, []);
  ...
  <caption className="sr-only">Karton Çanta Fiyat Listesi</caption>
  <thead>
...
<th scope="col" className="p-4 text-center border-r-2 border-slate-700/30">EBAT</th>
                  ...
                  {flatItems.map((item, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <th scope="row" className="p-3 text-center font-bold text-primary border-r-2 border-slate-200 group-hover:text-secondary transition-colors">
  {item.code}
</th>
        ...
        <div className="mb-12 mt-6 bg-sky-50/50 border border-sky-100 rounded-[2rem] p-5 flex flex-col sm:flex-row items-center gap-4 shadow-sm text-black">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-sm font-black text-slate-900 uppercase mb-0.5">Sipariş Oluşturma Adımları</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm flex gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-black uppercase text-xs mb-1">{item.title}</h3>
                    <p className="text-xs text-gray-650 font-semibold leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="bg-white p-5 rounded-2xl border border-gray-150 shadow-sm">
                  ...
                  <h3 className="font-black text-black uppercase text-xs mb-2">{item.desc}</h3>
          ...
          <section className="bg-white p-8 rounded-[32px] border border-gray-150 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs sm:text-sm font-semibold leading-relaxed text-gray-650">
              <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-100">
                <h3 className="font-black text-black uppercase text-xs mb-1.5">Körük ve İç Baskı</h3>
              ...
              <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-100">
                <h3 className="font-black text-black uppercase text-xs mb-1.5">Sıradışı Minimalizm</h3>
              ...
              <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-100">
                <h3 className="font-black text-black uppercase text-xs mb-1.5">Taban Takviyesi</h3>
