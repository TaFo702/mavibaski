...
export const MatbaaPage = () => {
  ...
  const banners = [
    ...
    },
    {
      ...
      subtitle: "46x68 mm Standart Boyut • Parlak Selefonlu & Dayanıklı • En Uygun Fiyat Garantisi • Hızlı Üretim ve Kargo",
      image: "/b3.webp",
    ...
    },
    {
      ...
      subtitle: "14x20 cm Yarım Boy • Otokopili Kağıda 1 Renk Baskı • Numaralı ve Ciltli Üretim • Kurumsal Tasarım",
      image: "/b4.webp",
      blueBtn: { text: "Hemen Sipariş Ver", link: WHATSAPP_LINK },
    ...
    },
    {
      ...
      subtitle: "Dürüm, Hamburger, Pasta ve Baklava Kutuları • 350 gr Bristol + Mat Selefon • Adetli Üretim İndirimleri",
      image: "/b5.webp",
  ...
  return (
    <div className="bg-white min-h-screen">
      <Helmet>
        <title>Matbaa Hizmetleri ve Üretim Tesisimiz - Mavi Basım</title>
        <meta name="description" content="Topkapı 2. Matbaacılar Sitesinde kurulu modern ofset ve dijital baskı makinelerimizle uygun fiyatlı, yüksek kaliteli kurumsal broşür, kutu matbaa çözümleri." />
      </Helmet>
      {/* Hero Section Slider */}
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center text-center px-4">
              <div className="max-w-5xl w-full">
                <motion.h1 
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tight mb-4 leading-tight whitespace-normal sm:whitespace-nowrap"
                >
                ...
                <motion.p 
                  ...
                  className="text-sm sm:text-base md:text-lg font-bold text-primary mb-6 max-w-3xl mx-auto"
                >
          ...
          <div className="space-y-8 lg:-mt-12">
            ...
            <div className="space-y-6 text-black font-medium leading-relaxed">
              <p className="text-xl md:text-2xl font-bold">
                Türkiye’de online matbaa sipariş sistemini ilk hayata geçiren öncü platformlardan biri olarak hizmet veriyoruz. 
                İnternet üzerinden baskı siparişi verme kolaylığını yüksek kalite standartlarıyla buluşturuyoruz.
              </p>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { id: "1", title: "Online Öncüsü", desc: "Türkiye'de online matbaacılığın öncü adresi." },
            { id: "2", title: "81 İl Kargo", desc: "Kapınıza kadar güvenli teslimat." },
            { id: "3", title: "Doğrudan İmalatçı", desc: "Topkapı üretim tesisimiz ile aracısız fiyat avantajı." },
      ...
      <section id="fiyatlar" className="py-20 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4">2026 Güncel Matbaa Fiyatları</h2>
            <p className="text-gray-400 font-semibold text-sm md:text-base leading-relaxed">
              2026 yılına ait güncel matbaa fiyatlarımız düzenli olarak güncellenmektedir. Kartvizit fiyatları, broşür fiyatları, afiş fiyatları, magnet fiyatları, etiket fiyatları, kutu fiyatları, katalog fiyatları, makbuz fiyatları ve diğer tüm baskı ürünlerinin güncel fiyatlarını inceleyebilirsiniz.
            </p>
          </div>
          ...
          <div className="mt-8 bg-white/5 px-5 py-3 border border-white/10 rounded-2xl flex flex-col sm:flex-row justify-center items-center text-xs text-gray-400 font-medium font-sans">
