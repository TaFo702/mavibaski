  ...
  return (
    <div className="bg-[#f3f4f6] min-h-screen pb-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://mavibasim.com/kataloglar" />
        <meta property="og:title" content="Katalog Baskı Fiyatları | Çok Sayfalı Ürün Kataloğu - Mavi Basım" />
        <meta property="og:description" content="A4 ve A5 ebatlarında, tel dikiş veya Amerikan ciltli, kuşe kağıda basılan profesyonel kurumsal tanıtım ve ürün katalog baskıları. En uygun imalat fiyatı." />
        <meta property="og:url" content="https://mavibasim.com/kataloglar" />
        <meta property="og:type" content="product" />
        <meta property="og:image" content="https://mavibasim.com/images/katalog/katalog-baski-fiyatlari.webp" />
        <meta property="og:image:secure_url" content="https://mavibasim.com/images/katalog/katalog-baski-fiyatlari.webp" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="533" />
        <meta property="og:image:alt" content="Mavi Basım A4 ve A5 tel dikişli ile Amerikan ciltli kurumsal ürün katalog baskısı" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Katalog Baskı Fiyatları | Çok Sayfalı Ürün Kataloğu - Mavi Basım" />
        <meta name="twitter:description" content="A4 ve A5 ebatlarında, tel dikiş veya Amerikan ciltli, kuşe kağıda basılan profesyonel kurumsal tanıtım ve ürün katalog baskıları. En uygun imalat fiyatı." />
        <meta name="twitter:image" content="https://mavibasim.com/images/katalog/katalog-baski-fiyatlari.webp" />
      </Helmet>
