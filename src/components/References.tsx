...
export const ReferanslarPage = () => {
  ...
  const strengths = [
    "Yıllara dayanan kesintisiz hizmet",
  ...
  return (
    <div className="bg-white min-h-screen pt-8 pb-16 md:pt-12 md:pb-24">
      <Helmet>
        <title>Referanslarımız ve Güven Sinyalleri - Mavi Basım</title>
        <meta name="description" content="Bugüne kadar başarıyla tamamladığımız kurumsal ambalaj, broşür, magnet ve kartvizit projelerimiz ile bizi tercih eden mutlu müşteri referanslarımız." />
      </Helmet>
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-black uppercase tracking-tighter mb-4 leading-none">
            Mutlu Müşteri Referanslarımız ve Kurumsal Referanslar
          </h1>
          <p className="text-gray-500 font-medium text-lg max-w-3xl mx-auto leading-relaxed">
            Yıllardır binlerce firmaya, kuruma ve markaya baskı hizmeti sunduk. Bu referanslar, kalitemizin ve güvenilirliğimizin en güzel kanıtıdır.
          </p>
        </div>
