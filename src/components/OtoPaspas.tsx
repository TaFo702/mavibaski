...
export const OTO_PASPAS_GALLERY = [
  {
    ...
    desc: "Oto servis ve oto yıkama işletmeleri için kraft oto paspas fiyatları."
  },
  {
...
export const OtoPaspasPage = () => {
  ...
  useEffect(() => {
    document.title = "Oto Paspas Baskı Fiyatları | Logolu Kağıt Oto Paspas";
  }, []);
...
>
  ...
  Oto servis, bakım istasyonları, ekspertiz ve oto yıkama işletmeleri için <strong className="text-slate-900 font-semibold">oto paspas baskı</strong>, <strong className="text-slate-900 font-semibold">baskılı oto paspas</strong>, <strong className="text-slate-900 font-semibold">logolu oto paspas</strong> ve <strong className="text-slate-900 font-semibold">baskılı oto paspas kağıdı</strong> çözümleri sunuyoruz. 80 gr esmer kraft kâğıt üzerine tek renk ofset baskıyla hazırlanan <strong className="text-slate-900 font-semibold">oto kağıt paspas</strong> ve <strong className="text-slate-900 font-semibold">kağıt oto paspas</strong> ürünleri; <strong className="text-slate-900 font-semibold">araç içi kağıt paspas</strong> veya <strong className="text-slate-900 font-semibold">araba için kağıt paspas</strong> olarak değerlendirilebilir. Tek kullanımlık oto paspas seçenekleri, servis ve temizlik işlemleri sırasında araç tabanının kirlenmesini azaltmaya yardımcı olur. Siparişleriniz <strong className="text-slate-900 font-semibold">İstanbul Topkapı 2. Matbaacılar Sitesi’ndeki hizmet ve koordinasyon noktası</strong> üzerinden koordine edilerek anlaşmalı kargo ile tarafınıza ulaştırılır.
</p>
            </div>
  ...
  Aşağıdaki tabloda güncel <strong>oto paspas fiyatları</strong> ve <strong>oto paspas baskı fiyatları</strong> yer almaktadır. Standart sipariş paketlerimiz 1.000 adetten başlar; tabloda 1.000, 2.000 ve 5.000 adet seçenekleri bulunur. <strong>Oto paspas kağıdı fiyatları</strong>, <strong>oto kağıt paspas fiyatları</strong> ve <strong>kağıt paspas fiyatları</strong> adet, ebat, gramaj ve baskı türüne göre değişir. <strong>Oto kağıt paspas toptan</strong>, <strong>oto yıkama paspası</strong> ve <strong>oto yıkama kağıt paspas</strong> talepleri için ürün detaylarına göre özel teklif hazırlanır.
</p>

          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-visible relative z-10">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse min-w-[700px]">
  <caption className="sr-only">Oto Paspas Fiyat Listesi</caption>
                <thead>
                ...
                <tbody className="divide-y divide-gray-100 text-xs sm:text-sm">
                  {OTO_PASPAS_DATA.map((item, idx) => (
                    ...
                    >
                      <th scope="row" className="py-4 px-4 sm:px-6 font-mono font-bold text-primary">
  {item.code}
</th>
...
className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-5 rounded-xl border border-gray-200">
                ...
                <p className="text-xs text-gray-650 leading-relaxed">
                  Doğal esmer dokulu <strong>oto paspas kağıt</strong> materyali, hafif yapısıyla araç tabanına rahatça serilir. Ayakkabı tabanındaki kuru toz ve yüzeysel kirlerin halıya geçmesini azaltmaya yardımcı olur.
                </p>
              </div>
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200">
                ...
                <p className="text-xs text-gray-650 leading-relaxed">
                  Baskıya hazır olarak ilettiğiniz tasarım dosyaları için teknik kontrol ve dijital PDF prova sunulmaktadır. Grafik desteği var.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="my-10">
          <RelatedBlogPosts
            category="oto-paspas"
            excludeImages={["/images/oto-paspas/oto-paspas-kagit-baski.webp"]}
          />
        </div>
