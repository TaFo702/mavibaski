...
export const Footer = () => {
  ...
  return (
    <footer id="contact" className={`bg-black text-white pt-10 ${isKutuPage ? 'pb-44 sm:pb-48' : 'pb-8'} border-t border-zinc-900 relative`}>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-white/10">
          ...
          <div className={`space-y-3 ${isKutuPage ? 'pr-16 sm:pr-0' : ''}`}>
