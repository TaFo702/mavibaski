...
export const YAG_KARTI_GALLERY = [
  {
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm md:text-base font-bold text-slate-700 mb-2">
            350 gr kuşe veya 700 gr sıvama seçenekleri, mat selefonlu yüzey, asma deliği ve bağlama ipliği içeren yağ kartı modellerini inceleyebilirsiniz. Yağ kartı baskı ürünü, oto servislerin yağ değişim tarihi, kilometre ve filtre bilgilerini müşterilerine hatırlatmak için kullandığı logolu bir yağ bakım kartıdır.
          </p>
        ...
        <div id="fiyat-tablosu" className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden mb-8 relative z-10 scroll-mt-20">
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-xs sm:text-sm">
              <caption className="sr-only">Yağ Kartı Fiyat Listesi</caption>
              <thead>
                <tr className="bg-slate-900 text-white">
                  <th scope="col" className="p-4 w-10">
                    <span className="sr-only">Kategori</span>
                  </th>
                  <th scope="col" className="p-4 w-28 text-left font-black uppercase tracking-wider text-xs sm:text-sm border-r border-slate-800">KOD</th>
                  <th scope="col" className="p-4 text-center font-black uppercase tracking-wider text-xs sm:text-sm border-r border-slate-800">EBAT</th>
                  <th scope="col" className="p-4 text-center font-black uppercase tracking-wider text-xs sm:text-sm border-r border-slate-800">AÇIKLAMA</th>
                  <th scope="col" className="p-4 text-center font-black uppercase tracking-wider text-xs sm:text-sm border-r border-slate-800">ADET</th>
                  <th scope="col" className="p-4 w-32 text-center font-black uppercase tracking-wider text-xs sm:text-sm border-r border-slate-800">FİYAT</th>
                  <th scope="col" className="p-4 w-44 text-center font-black uppercase tracking-wider text-xs sm:text-sm">SİPARİŞ</th>
                </tr>
              </thead>
              <tbody>
                {YAG_KARTI_DATA[0].items.map((item: ReklamItem, idx: number) => (
                  <tr key={idx} className="border-b border-slate-100 hover:bg-primary/5 transition-all group">
                    ...
                    <th scope="row" className="p-4 text-left font-bold text-primary border-r border-slate-100 group-hover:text-secondary transition-colors">
                      {item.code}
                    </th>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200">
            ...
            <h3 className="font-black text-slate-900 text-sm mb-1.5">Yağ Kartı Fiyatları Neye Göre Değişiyor?</h3>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-slate-200 gap-4">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 uppercase tracking-tight">
                Yağ Kartı Örnekleri ve Baskı Detayları
              </h2>
            </div>
