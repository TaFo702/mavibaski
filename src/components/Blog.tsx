...
const getRelatedProducts = (slug: string, category: string) => {
  ...
  if (
    ...
    return {
      ...
      products: [
        { name: "Amerikan Servis", desc: "Özel Baskılı Masa Altlığı", reason: "Masalarınızın temizliğini ve hijyenik kurumsal algısını korumak için tercih edin.", path: "/amerikan-servis", img: "/images/amerikan-servis/amerikan-servis-baski.webp", alt: "Amerikan Servis Baskısı", title: "Restoran Amerikan Servis Baskısı" },
        { name: "Adisyon Baskısı", desc: "Otokopili Garson Fişleri", reason: "Masa ve paket sipariş takip süreçlerinizi seri numaralı fişlerle kolaylaştırın.", path: "/adisyon", img: "/images/adisyon/otokopili-adisyon-baski.webp", alt: "Adisyon Fişi Baskısı", title: "Restoran Adisyon Fişi Baskısı" },
        { name: "Tanıtım Broşürü", desc: "Katlamalı Yemek Menüleri", reason: "Paket servislerde müşterilerinize sunacağınız şık yemek menüleri hazırlayın.", path: "/brosur", img: "/images/brosur/brosur-tasarimi-ve-baski.webp", alt: "Tanıtım Broşürü", title: "Restoran Yemek Menüsü" },
        { name: "Magnet Baskı", desc: "Buzdolabı Magnetleri", reason: "Müşterilerinizin buzdolaplarında ve mutfaklarında 7/24 kalıcı yer edinin.", path: "/magnet", img: "/images/magnet/oval-kesim-magnet.webp", alt: "Magnet Baskısı", title: "Paket Servis Magnet Baskısı" },
        { name: "Karton Çanta", desc: "Lüks Paketleme Çantaları", reason: "Paket servislerde ve lüks paketlemelerde müşterinize prestijli taşıma sunun.", path: "/karton-canta", img: "/images/karton-canta/karton-canta-tasarimi.webp", alt: "Karton Çanta Baskısı", title: "Restoran Karton Paket Servis Çantası" }
      ]
    };
  }
  ...
  if (
    ...
    return {
      ...
      products: [
        { name: "Tanıtım Broşürleri", desc: "Kırımlı Akordeon Broşür", reason: "Detaylı firma veya ürün listesi tanıtımları yapmak için tercih edin.", path: "/brosur", img: "/images/brosur/katlamali-brosur-baski.webp", alt: "Tanıtım Broşürü", title: "Katlamalı Tanıtım Broşürü" },
        { name: "El İlanı Baskı", desc: "Hızlı Dağıtım El İlanı", reason: "Hızlı kitle dağıtımları ve ekonomik sokak reklamları için seçin.", path: "/el-ilani", img: "/images/el-ilani/el-ilani-baski-fiyatlari.webp", alt: "El İlanı Baskısı", title: "A5 Tek Yön El İlanı Baskısı" },
        { name: "Katalog Baskı", desc: "Çok Sayfalı Ürün Kataloğu", reason: "Tek bir broşürün sığdıramayacağı zengin ürün portföyleri için yönelin.", path: "/kataloglar", img: "/images/katalog/tanitim-katalogu-ornegi.webp", alt: "Katalog Baskısı", title: "Çok Sayfalı Ürün Kataloğu Baskısı" },
        { name: "Afiş Baskı", desc: "Büyük Boy Mağaza Afişi", reason: "Fuar alanı, dükkan vitrini veya dış mekanda dikkat çekmek için kullanın.", path: "/afis", img: "/images/afis/afis-baski-fiyatlari.webp", alt: "Afiş Baskısı", title: "50x70 and 70x100 Afiş Baskısı" },
        { name: "Kartvizit", desc: "Kalın Selefonlu Kartvizit", reason: "Müşterilerinizde kalıcı ve taşınabilir bir ilk izlenim bırakmak için geçin.", path: "/kartvizit", img: "/images/kartvizit/kartvizit-baski.webp", alt: "Kartvizit Baskısı", title: "Kurumsal Selefonlu Kartvizit" }
      ]
    };
  }
  ...
  if (normSlug.includes('magnet') || normCategory.includes('magnet')) {
    return {
      ...
      products: [
        { name: "Magnet Baskı", desc: "Oval & Özel Figürlü Magnet", reason: "Mutfaklarda ve dolap kapaklarında 7/24 görünür kalarak akla ilk gelen olun.", path: "/magnet", img: "/images/magnet/oval-kesim-magnet.webp", alt: "Magnet Baskısı", title: "Reklam Magnet Baskısı" },
        { name: "El İlanı Baskı", desc: "Canlı Renkli Paket El İlanı", reason: "Hızlı sokak dağıtımları ve posta kutusu reklamları için bütçe dostu tanıtım.", path: "/el-ilani", img: "/images/el-ilani/el-ilani-baski-fiyatlari.webp", alt: "El İlanı Baskısı", title: "Paket Servis El İlanı" },
        ...
        { name: "Amerikan Servis", desc: "Logolu Hijyenik Kağıt Servis", reason: "Restoran ve kafelerin masa düzeninde kurumsal sunumu destekleyen baskılı servis seçenekleri.", path: "/amerikan-servis", img: "/images/amerikan-servis/amerikan-servis-baski.webp", alt: "Amerikan Servis Baskısı", title: "Kağıt Amerikan Servis" },
        { name: "Karton Çanta", desc: "Lüks Paketleme Çantaları", reason: "Paket servislerde ürün sunumunu ve taşıma düzenini destekleyen baskılı karton çanta seçenekleri.", path: "/karton-canta", img: "/images/karton-canta/karton-canta-tasarimi.webp", alt: "Karton Çanta Baskısı", title: "Paket Servis Karton Çantası" }
      ]
    };
  }
  ...
  if (
    ...
    return {
      ...
      products: [
        { name: "Magnet Baskı", desc: "Oval Kesimli Buzdolabı Magneti", path: "/magnet", img: "/images/magnet/oval-kesim-magnet.webp", alt: "Magnet Baskısı", title: "Reklam Magnet Baskısı" },
        { name: "Yağ Kartı Baskısı", desc: "Oto Servis Takip Kartları", path: "/yag-karti", img: "/images/yag-karti/yag-karti-baski.webp", alt: "Yağ Kartı Baskısı", title: "Oto Servis Yağ Değişim Kartı" },
        { name: "Kitap Ayracı", desc: "Özel Tasarım Kitap Ayraçları", path: "/kitap-ayraci", img: "/images/kitap-ayraci/kitap-ayraci-baski.webp", alt: "Kitap Ayracı Baskısı", title: "Promosyon Kitap Ayracı Baskısı" },
        { name: "Oto Paspas", desc: "Emici Kraft Kağıt Paspaslar", path: "/oto-paspas", img: "/images/oto-paspas/oto-paspas-kagit-baski.webp", alt: "Oto Paspas Baskısı", title: "Baskılı Kraft Kağıt Oto Paspası" },
        { name: "Küp Bloknot", desc: "Kutulu Promosyon Bloknotlar", path: "/kup-bloknot", img: "/images/kup-bloknot/kup-bloknot-baski-fiyatlari.webp", alt: "Küp Bloknot Baskısı", title: "Logolu Kutulu Küp Bloknot" }
      ]
    };
  }
  ...
  if (
    ...
    return {
      ...
      products: [
        { name: "Etiket Baskı", desc: "Rulo ve Tabaka Opak Etiket", path: "/etiket", img: "/images/etiket/yapiskanli-etiket-baski.webp", alt: "Etiket Baskısı", title: "Yapışkanlı Rulo ve Tabaka Etiket" },
        { name: "Kutu Baskı", desc: "Özel Ölçülü Karton ve Kraft Kutular", path: "/kutu", img: "/images/kutu/urun-kutusu-baski.webp", alt: "Kutu Baskısı", title: "Özel Kesim Karton Kutu İmalatı" },
        { name: "Ambalaj Baskı", desc: "Sargılık Kağıt ve Esnek Ambalajlar", path: "/ambalaj", img: "/images/ambalaj/ambalaj-baski-fiyatlari.webp", alt: "Ambalaj Baskısı", title: "Baskılı Sarım Kağıtları ve Ambalaj" },
        { name: "Karton Çanta", desc: "Lüks İpli Mağaza Çantaları", path: "/karton-canta", img: "/images/karton-canta/karton-canta-baski-fiyatlari.webp", alt: "Karton Çanta Baskısı", title: "Kurumsal Karton Çanta Baskısı" },
        { name: "Oluklu Koli", desc: "Dayanıklı Kargo Kolileri", path: "/kutu", img: "/images/kutu/karton-kutu-baski-fiyatlari.webp", alt: "Oluklu Koli Baskısı", title: "Baskılı Oluklu Kargo Kolisi" }
      ]
    };
  }
  ...
  return {
    ...
    products: [
      { name: "Kartvizit", desc: "Premium Kartvizitler", path: "/kartvizit", img: "/images/kartvizit/kartvizit-baski.webp", alt: "Premium Kartvizit Baskısı", title: "Lüks Kartvizit Baskısı" },
      { name: "Tanıtım Broşürü", desc: "Lüks ve Ekonomik Çözümler", path: "/brosur", img: "/images/brosur/katlamali-brosur-baski.webp", alt: "Tanıtım Broşürü", title: "Tanıtım Broşürü" },
      { name: "Magnet Baskı", desc: "Buzdolabı Magnetleri", path: "/magnet", img: "/images/magnet/oval-kesim-magnet.webp", alt: "Magnet Baskısı", title: "Mutfak Magnet Baskısı" },
      { name: "Cepli Dosya", desc: "Sunum Dosyaları", path: "/dosyalar", img: "/images/dosya/cepli-dosya-tasarimi.webp", alt: "Cepli Dosya Baskısı", title: "Kurumsal Cepli Dosya" },
      { name: "Tahsilat Makbuzu", desc: "Karbonlu Para Makbuzu", path: "/tahsilat-makbuzu", img: "/images/tahsilat-makbuzu/otokopili-tahsilat-makbuzu.webp", alt: "Tahsilat Makbuzu Baskısı", title: "Otokopili Tahsilat Makbuzu" }
    ]
  };
};
