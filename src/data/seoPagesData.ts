  ...
  'kuafor-kartvizit-baski': {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Hazır dosyalarınız için teknik dosya kontrolü yapılır ve baskı öncesi PDF prova iletilir. Grafik desteği var.'
      },
      {
  ...
  'restoran-brosur-baski': {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Baskıya hazır dosyalar için teknik kontrol yapılır. Grafik desteği var.'
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Grafik desteği var. Baskıya hazır dosyanın teknik kontrolü ve PDF prova kontrolü ücretsizdir.'
        ]
      }
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '2. Baskıya Hazır Dosyaların İletilmesi: Sayfa düzeni tamamlanmış, yüksek çözünürlüklü ve baskıya hazır PDF dosyalarınızı iletin. Grafik desteği var.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '3. Baskıya Hazır Dosya ve Bıçak Çiziminin Teknik Kontrolü: Müşteri tarafından iletilen baskıya hazır PDF dosyası ve bıçak izi kesim payı, kırım çizgileri ve renk formatı açısından kontrol edilir. Grafik desteği var.',
