...
${KUTU_DATA.map((item) => {
  ...
  return `            <tr class="hover:bg-blue-50/50 transition-colors">
              <td class="p-3 text-center font-black text-primary border-r border-gray-100">${item.code}</td>
