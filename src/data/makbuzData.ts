...
export const MAKBUZ_DETAILS: Record<string, MakbuzDetail> = {
  "adisyon": {
    ...
    faqList: [
      ...
      },
      {
        ...
        a: "Evet. Adisyon koçanlarınıza firmanızın logosu, unvanı, adresi, telefon bilgileri ve diğer kurumsal kimlik öğeleri grafik desteğimiz kapsamında eklenebilmektedir. Tasarım onayınız alındıktan sonra üretime geçilir."
      },
      {
  ...
  "tahsilat-ve-tediye-makbuzu": {
    ...
    specifications: [
      ...
      { title: "Nüsha Seçenekleri", value: "1 Asıl + 1 Suret, 1 Asıl + 2 Suret veya 1 Asıl + 3 Suret" },
  ...
  "tahsilat-makbuzu": {
    seoTitle: "Tahsilat Makbuzu Baskı Fiyatları | Otokopili ve Numaratörlü",
    ...
    faqList: [
      ...
      {
        q: "Tahsilat makbuzu nasıl doldurulur?",
        a: "Tahsilat makbuzu doldurulurken tarih, ödemeyi yapan kişi veya firma bilgileri, tahsilat tutarı, ödeme türü ve teslim alan yetkilinin imzası ilgili alanlara yazılır. Otokopili koçanlarda yazılan bilgiler alt nüshalara kendiliğinden kopyalanır."
      },
      {
        q: "Tahsilat makbuzu nasıl kesilir?",
        a: "Müşteriden ödeme alındığında koçandaki tarih, müşteri bilgisi ve tutar alanları tükenmez kalemle doldurularak karşılıklı imzalanır. Perforeli üst asıl nüsha koparılarak ödemeyi yapana verilir; alt suret koçanda muhafaza edilir."
      },
      {
...
export const SOZLESME_BASKI_DATA = [
  {
    ...
    rows: [
      { label: "1 Asl+1 Su.", values: [2000, 2250, 2900, 3200, 3700, 4000, 5000, 5750, 9250] },
      { label: "1 Asl+2 Su.", values: [2100, 2700, 3400, 3850, 4500, 5100, 6200, 7500, 13500] },
      { label: "1 Asl+3 Su.", values: [2250, 3000, 3850, 4600, 5300, 6000, 7750, 9250, 16500] },
      { label: "2. Renk Farkı", values: [900, 900, 1150, 1250, 1350, 1400, 1900, 2400, 3400] }
    ]
  }
];
...
export const SIPARIS_FISI_DATA = [
  {
    ...
    rows: [
      { label: "1 Asl+1 Su.", values: [1900, 2000, 2250, 2950, 3200, 3700, 5750] },
      { label: "1 Asl+2 Su.", values: [2000, 2100, 2750, 3500, 3850, 4500, 7500] },
      { label: "1 Asl+3 Su.", values: [2100, 2250, 3000, 3900, 4600, 5400, 9250] },
      { label: "2. Renk Farkı", values: [900, 900, 1150, 1300, 1400, 1600, 2400] }
    ]
  }
];
...
export const PARA_MAKBUZU_DATA = [
  {
    ...
    rows: [
      { label: "1 Asl+1 Su.", values: [1900, 2000, 2250, 2950, 3700, 5750] },
      { label: "1 Asl+2 Su.", values: [2000, 2100, 2750, 3500, 4500, 7500] },
      { label: "1 Asl+3 Su.", values: [2100, 2250, 3000, 3900, 5400, 9250] },
      { label: "2. Renk Farkı", values: [900, 900, 1150, 1300, 1600, 2400] }
    ]
  }
];
...
export const ADISYON_DATA = [
  {
    ...
    rows: [
      { label: "Fiyat", values: [1850, 2000, 2100, 2500, 2800, 3900, 6000, 12500, 22500] },
      { label: "Renk Farkı", values: [900, 900, 900, 1150, 1150, 1400, 2400, 3400, 3900] }
    ]
  }
];
...
export const SIGORTA_POLICELERI_DATA = [
  {
    ...
    headers: ["5 CİLT", "10 CİLT", "20 CİLT", "30 CİLT", "40 CİLT", "50 CİLT", "100 CİLT"],
    rows: [
      { label: "1 Asl+1 Su.", values: [2000, 2250, 3200, 4000, 5000, 5750, 9250] },
      { label: "1 Asl+2 Su.", values: [2100, 2700, 3850, 5100, 6200, 7500, 13500] },
      { label: "2. Renk Farkı", values: [900, 900, 1250, 1400, 1900, 2400, 3400] }
    ]
  }
];
...
export const GIRIS_BILETI_DATA = [
  {
    ...
    headers: ["5 CİLT", "10 CİLT", "20 CİLT", "40 CİLT", "50 CİLT", "100 CİLT"],
    rows: [
      { label: "Fiyat", values: [1850, 2000, 2100, 2500, 2800, 3900] },
      { label: "Renk Farkı", values: [900, 900, 900, 1150, 1150, 1400] }
    ]
  }
];
...
export const TEDIYE_MAKBUZU_DATA = [
  {
    ...
    headers: ["5 CİLT", "10 CİLT", "20 CİLT", "30 CİLT", "50 CİLT", "100 CİLT"],
    rows: [
      { label: "1 Asıl + 1 Suret", values: [1900, 2000, 2250, 2950, 3700, 5750] },
      { label: "1 Asıl + 2 Suret", values: [2000, 2100, 2750, 3500, 4500, 7500] },
      { label: "1 Asıl + 3 Suret", values: [2100, 2250, 3000, 3900, 5400, 9250] },
      { label: "2. Renk Farkı", values: [900, 900, 1150, 1300, 1600, 2400] }
    ]
  }
];
...
export const PERAKENDE_SATIS_FISI_DATA = [
  {
    ...
    ozellik: "Otokopili Kağıda 1 Renk Baskılı - Numaratörlü",
    headers: ["5 CİLT", "10 CİLT", "20 CİLT", "50 CİLT", "100 CİLT", "200 CİLT", "250 CİLT", "300 CİLT", "500 CİLT"],
    rows: [
      { label: "1 Asl+1 Su.", values: [1850, 2000, 2100, 2800, 3900, 6000, 7500, 9000, 12500] },
      { label: "1 Asl+2 Su.", values: [1950, 2100, 2200, 3500, 4750, 8000, 9250, 12000, 16500] },
      { label: "1 Asl+3 Su.", values: [2050, 2200, 2400, 4000, 5700, 9750, 13000, 14500, 21000] },
      { label: "2. Renk Farkı", values: [900, 900, 1150, 1150, 1400, 2400, 2400, 2400, 3400] }
    ]
  }
];
