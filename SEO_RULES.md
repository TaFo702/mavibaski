...
* **Structured Data (Schema.org / JSON-LD):**
  * Ürün sayfalarında `Product` ve `Offer` şemaları. `Review` ve `AggregateRating` şemaları yalnızca gerçek, görünür ve doğrulanabilir değerlendirme verisi varsa kullanılabilir; doğrulanmamış şema eklenemez.
